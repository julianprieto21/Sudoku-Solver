...
if __name__ == "__main__":
    ...
    show_boxes --> Mostrar todas las imagenes de los numeros del sudoku / Show all images of sudoku numbers
    show_board --> Mostrar sudoku entero / show entire sudoku
    """
    print(board) # Mostrar sudoku leido
    print("#-------------x-------------#")
    solve_sudoku(board) # Resolver sudoku
    print(board) # Mostrar sudoku resuelto
    print(valid_sudoku(board)) # Valida si el sudoku esta resuelto correctamente